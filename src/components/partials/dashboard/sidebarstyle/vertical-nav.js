...
function CustomToggle({ children, eventKey, onClick, to }) {
    ...
    return (
        <Link to={to} aria-expanded={isCurrentEventKey ? 'true' : 'false'} className="nav-link" role="button" onClick={(e) => {
...
const VerticalNav = () => {
    ...
    return (
        <>
            <div as="ul" className="navbar-nav iq-main-menu">

                <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix="nav-item" >
                    <CustomToggle to="/admin" eventKey="horizontal-menu" onClick={(activeKey) => setActiveMenu(activeKey)}>
                        <i className="icon">
