...
import { Row, Col, Dropdown, Form, Nav, Tab, Button } from 'react-bootstrap'
...
// Table Modal
import { Modal } from '../../components/modal/table.modal.js'
...
const Admin = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const tableData = `TableName: ${tableName}, Seats: ${seats}`;
        QRcode.toDataURL(tableData).then((data) => {
            setQrcode(data)
            console.log(data);
        })
        var res = await tableApi.addTable({
            name: tableName,
            desc: desc,
            numberOfSeats: seats
        })
        if (res.message === 'success' || res.success === true) {
            ...
            setShow(false);
            window.alert("Error In Adding New Table!");
        }
                                    ...
                                    <SwiperSlide className="text-center"
                                        ...
                                        <div className="card-profile-progress mb-3">
                                            <Circularprogressbar Linecap='rounded' trailstroke='#ddd' strokewidth="8px" value={65} stroke="#EA6A12" style={{ width: '150px', height: '150px' }}>
                                                <img src={qrcode ? qrcode : lay13} className="img-fluid  rounded-circle card-img rotete-infinite" alt="image1" />
                                            </Circularprogressbar>
                                        </div>
                        ...
                        </div>
                        {
                            show ?
                                <div className="card" data-iq-gsap="onStart"
                                    ...
                                    data-iq-ease="none">
                                    <div className="card-header">
                                        <h4 className="card-title">Add New Table</h4>
                                    </div>
                                            ...
                                            <div className="d-flex align-items-center">
                                                <Form>
                                                    <Row>
                                                        <Col lg="12">
                                                            <Form.Group className="form-group">
                                                                ...
                                                                <Form.Control onChange={(e) => { setTableName(e.target.value) }} value={tableName} type="text" className="form-control-sm" id="tableName" aria-describedby="email" placeholder=" " />
                                                            </Form.Group>
                                                        </Col>
                                                        <Col lg="12">
                                                            <Form.Group className="form-group">
                                                                <Form.Label htmlFor="seats">Seats</Form.Label>
                                                                <Form.Control onChange={(e) => { setSeats(e.target.value) }} value={seats} type="text" className="form-control-sm" id="" aria-describedby="password" placeholder=" " />
                                                            </Form.Group>
                                                        </Col>
                                                        <Col lg="12">
                                                            <Form.Group className="form-group">
                                                                <Form.Label htmlFor="desc">Description</Form.Label>
                                                                <Form.Control onChange={(e) => { setDesc(e.target.value) }} value={desc} type="text" className="form-control-sm" id="" aria-describedby="password" placeholder=" " />
                                                            </Form.Group>
                                                        </Col>
                                                    ...
                                                    <div className="d-flex justify-content-center">
                                                        <Button onClick={(e) => handleSubmit(e)} type="submit" variant="primary">Add</Button>
                                                    </div>
                                                </Form>
                                            </div>
                                        </div>
                                ...
                                <div className="card" data-iq-gsap="onStart"
                                    ...
                                    <div className="card-header">
                                        ...
                                        <button onClick={() => setShow(true)} className="btn btn-primary">Add Table</button>
                                    </div>
                                    <Card.Body>
